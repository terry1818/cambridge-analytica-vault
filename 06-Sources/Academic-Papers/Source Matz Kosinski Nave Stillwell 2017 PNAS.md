...
authors: [Sandra C. Matz, Michal Kosinski, Gideon Nave, David J. Stillwell]
...
Matz, S. C.; Kosinski, M.; Nave, G.; Stillwell, D. J. (2017-11-28). "Psychological targeting as an effective approach to digital mass persuasion." *Proceedings of the National Academy of Sciences*, 114(48), 12714-12719. doi: 10.1073/pnas.1710966114.
...
- **Type:** peer-reviewed academic primary source; PNAS-published with three field experiments
...
The Matz 2017 paper is the **strongest single piece of academic support** for the claim that psychographic targeting CAN produce measurable behavioral lift. It is therefore essential to both sides of the [[Lens - Disputed Claims]] dialectic:

- **For** the CA-effectiveness narrative: a peer-reviewed empirical demonstration that trait-matched advertising produces lift
- **Against** the maximalist CA-decided-the-election framing: the demonstrated effects are in commercial advertising contexts, with bounded effect sizes, and don't trivially transfer to electoral-scale political persuasion

This is the **honest empirical baseline** for the disputed-claims thread.

## Entities mentioned

- [[Michal Kosinski]], [[David Stillwell]] (Cambridge Psychometrics Centre authorship line)
- Sandra C. Matz (lead author, then at Columbia Business School)
- Gideon Nave (Wharton)
- [[Facebook]] (advertising platform substrate)
...
- [ ] What replication-study effect sizes have been reported since 2017?
- [ ] Has any peer-reviewed work directly tested the same methodology in **political** persuasion contexts at electoral scale?
- [ ] Do the authors' subsequent publications address the academic-publication-enables-misuse argument?

## Archive

- DOI: 10.1073/pnas.1710966114
- Open-access at PNAS
- Local archive: `_attachments/pdfs/matz-2017-pnas.pdf` (if archived locally)
