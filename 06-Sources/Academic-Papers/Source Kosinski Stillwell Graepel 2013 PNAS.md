...
Kosinski, M.; Stillwell, D.; Graepel, T. (2013-04-09). "Private traits and attributes are predictable from digital records of human behavior." *Proceedings of the National Academy of Sciences*, 110(15), 5802-5805. doi: 10.1073/pnas.1218772110.
...
- **Methodology:** Logistic / linear regression on **Facebook Like patterns** from **58,466 volunteers** (myPersonality app population) with their consent
- **Predictive accuracy (highlights):**
  - **Male sexual orientation:** 88% accuracy
  - **African-American vs Caucasian:** 95% accuracy
  - **Democrat vs Republican:** 85% accuracy
  - **Christianity vs Islam:** 82% accuracy
  - **Big Five personality traits:** correlations 0.30-0.43 with self-report measures
...
> "Similar predictions could be made from all manner of digital data, with this type of secondary inference seemingly necessitating new means of preserving user privacy."
...
The **academic-enabling-event** citation for [[Hypothesis - Academic methodology proliferation enabled CA]]. Also cited from:

- [[Aleksandr Kogan]] (who later cloned the methodology via [[Global Science Research (GSR)|GSR]])
- [[Cambridge Psychometrics Centre]]
- [[Psychographic Targeting]] (concept node)
- [[OCEAN Model]] (concept node)
- [[Methodology - Verifying a CA claim]] (the disputed-impact thread)

## Open questions

- [ ] Do the authors' post-2018 reflections (Kosinski, Stillwell publicly) address the academic-publication-enables-misuse argument?
- [ ] How directly did CA's actual production methodology trace to this paper vs. to derivative or independent work?

## Archive

- DOI: 10.1073/pnas.1218772110
- Open-access at PNAS
- Local archive: `_attachments/pdfs/kosinski-2013-pnas.pdf` (if archived locally)
