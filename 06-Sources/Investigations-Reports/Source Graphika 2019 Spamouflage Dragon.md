...
title: "Spamouflage Dragon: A Persistent Chinese Influence Operation"
publisher: Graphika
publication_date: 2019-09-25
url: https://graphika.com/reports/spamouflage-dragon/
accessed: 2026-05-16
reliability: high
---
...
Graphika. (2019-09-25). *Spamouflage Dragon: A Persistent Chinese Influence Operation.* <https://graphika.com/reports/spamouflage-dragon/>.
...
- **Attribution:** Network attributed to a **persistent Chinese state-linked operator**, distinct from earlier Chinese platform-policy interventions
- **Operational signature:** Large-scale **cross-platform persona networks** (Twitter, YouTube, Facebook, Instagram, and emerging platforms like TikTok)
...
- **Type:** investigation-report from a specialist firm
...
- [[Spamouflage Dragonbridge]] (subject)
- [[Meta]], Twitter/X, YouTube (platforms targeted)
- Chinese state (attributed source)
...
- Live URL: <https://graphika.com/reports/spamouflage-dragon/>
- Graphika's reports are typically PDFs hosted on their site; capture both the report and its citation chain for durability
