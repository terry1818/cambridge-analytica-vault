---
date: 2026-05-16
description: Structured analysis of what HindsightFiles has released, what is known, and what remains unanalyzed
aliases: ["Source: HindsightFiles Analytical Index", "Source HindsightFiles Analytical Index"]
tags: [source, evidence/leak, topic/cambridge-analytica, era/2018-2020, era/2020-2024]
type: source
source_type: leak-analysis
title: HindsightFiles Analytical Index
publisher: Vault analysis (cambridge-analytica-vault)
...
A trove of **100,000+ documents** released by [[Brittany Kaiser]] beginning **2020-01-04** via the **@HindsightFiles** Twitter account. Material was pulled from Kaiser's personal email accounts and hard drives accumulated during her time as Director of Business Development at [[Cambridge Analytica]]. Kaiser has described the archive as the "complete" picture of CA's global operations.
...
## Countries / topics with confirmed material released
...
The vast majority of the 100,000+ documents has **not received public journalistic or academic analysis.** Specifically:

- Most country-specific operational detail (timing, contracts, contacts, methods)
- Cross-reference between CA's claimed and actual client lists
- Internal correspondence about successor planning (Emerdata, Auspex, Data Propria)
- Internal correspondence about Russian / Lukoil approaches
- Internal correspondence about Israeli intelligence cooperation
- Detailed budget / payment records (which would document money flows)
- Methodological documents (psychographic model architecture details)
- Internal disputes / dissent / departures
...
1. **Per-country event nodes** should cite specific HindsightFiles documents where they prove claims
2. **Connection notes** should document specific documents from the archive
3. **Hypothesis nodes** should be tested against archive material
4. **As releases continue or more analysis becomes public, add references back to this index**

## Open questions specific to HindsightFiles

- [ ] Has the full archive been provided to any regulator (FTC, ICO, DCMS)?
- [ ] What documents specifically corroborate the Brexit/Leave.EU work that ICO concluded did not occur?
- [ ] What documents corroborate or contradict CA's claimed 68-country scope?
- [ ] What evidence exists in the archive of CA's "deletion" certifications being false beyond the NYT viewing?

## Citation

Kaiser, Brittany [@HindsightFiles]. (2020-01-04 onwards). HindsightFiles document releases. Twitter/X.
