...
- [[Emma Briant]] (author)
- [[SCL Group]], [[Cambridge Analytica]], [[Leave.EU]] (subjects)
- [[Arron Banks]], [[Andrew Wigmore]] (Leave.EU principals)
- [[Alexander Nix]] (SCL/CA principal)
- DCMS Committee (publishing authority)
- Goddard Gunster (Leave.EU US-side consulting firm)

## How I'm using this

- [[Emma Briant]] (researcher node)
- [[SCL Group]] (pre-CA operations evidence)
- [[Leave.EU]] (operational-coordination evidence)
...
- [ ] What additional audio / transcript material was submitted but received less prominent treatment?
- [ ] Has Briant published a peer-reviewed academic monograph or article based on this same evidence base?
- [ ] Are the audio recordings publicly accessible, or only the transcripts?

## Archive

- Live URL: UK Parliament publishing portal (see DCMS Inquiry publications page)
- The DCMS Inquiry's full evidence package remains in the parliamentary record
- Briant's academic publications site may host adjacent material; Briant has been on social media commenting on the post-2018 successor ecosystem
