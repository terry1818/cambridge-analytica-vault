...
roles: [executive, donor-funder, investor, philosopher]
affiliations: [PayPal, Palantir Technologies, Founders Fund, Mithril Capital, Anduril (investor), Meta board (2005-2022), Thiel Foundation, Thiel Capital]
notable_for: Co-founder PayPal/Palantir; first Facebook outside investor; first Silicon Valley billionaire Trump backer; JD Vance patron; central Tech Right figure
status: active
...
Thiel is the **single most important contemporary connector** between:
1. **The CA-era influence-operations ecosystem** (Palantir engineer Chmieliauskas worked with CA; Thiel was Facebook board member during the CA-era harvest)
2. **The post-CA Mercer-Bannon political infrastructure** (Thiel allied with Mercer-Bannon during 2016 cycle)
...
- **PayPal Mafia:** [[Elon Musk]], Reid Hoffman, [[David Sacks]], Max Levchin, Roelof Botha
- **CA adjacency:** [[Palantir Technologies]] / [[Alfredas Chmieliauskas]]
- **Political proteges:** [[JD Vance]] (most prominent)
- **Trump-orbit:** [[Donald Trump]], [[Mark Zuckerberg]] (board colleague during CA era)
- **Intellectual movement:** [[Curtis Yarvin]], [[Patri Friedman]], [[Balaji Srinivasan]]
- **Anduril context:** [[Palmer Luckey]]
- **Right-wing podcast ecosystem:** [[David Sacks]] / All-In Podcast

## Open questions

- [ ] Specific Thiel-Vance political-strategy decisions during 2024 cycle
- [ ] Continuing Thiel-Yarvin operational coordination
- [ ] Full Thiel financial flows to political/intellectual organizations (limited public disclosure)
- [ ] Thiel role in DOGE / federal data-state architecture under Trump 2.0

## Sources

- [[Source Wikipedia - Peter Thiel]]
- [[Source DCMS Final Report 2019]]
- Multiple journalist accounts of 2024 VP selection process
- Reuters reporting on 2022 Ohio Senate race spending

## Detailed network map and operational footprint

**Founding ventures and exit capital:** Thiel co-founded PayPal in 1998 (sold to eBay 2002, generating the founder-pool wealth and personal relationships that became the [[PayPal Mafia]]), [[Palantir Technologies]] in 2003 (with In-Q-Tel as anchor investor), and [[Founders Fund]] in 2005 (VC vehicle through which most of his subsequent portfolio investments have flowed). He was the first outside investor in Facebook in 2004 ($500,000 for 10.2 percent equity), serving on the Meta board until 2022.

His political-vehicle structures include [[Mithril Capital]] (a separate VC fund focused on later-stage growth, co-founded with Ajay Royan), [[Narya Capital]] (the Cincinnati-based VC vehicle that JD Vance ran before entering politics, Thiel-anchored), and a network of nonprofit and policy-advocacy vehicles including the Thiel Foundation, the [[Hoover Institution]] (board), [[American Enterprise Institute]] (donor), and various smaller think-tank and fellowship structures.

**Documented portfolio overlaps that matter for the vault:** Founders Fund holdings include [[Palantir Technologies]], [[Anduril]] (Palmer Luckey defence-tech), Stripe, SpaceX, and a long list of frontier-tech firms. Mithril Capital portfolio overlaps with the political-influence question via specific investments that the [[Source Fortune 2025-05-21 Thiel Proteges Trump]] reporting catalogued.

## The Trump 2.0 personnel pipeline

The vault's analytical position is that the Thiel-funded personnel pipeline is the single most consequential factor in the 2024-2025 Tech Right ascendancy. Documented Thiel-funded or Thiel-mentored figures in or near Trump 2.0 include: [[JD Vance]] (vice president; Narya Capital; Thiel personal sponsorship of his 2022 Ohio Senate run with a $15M PAC contribution); [[Blake Masters]] (2022 Arizona Senate candidate, lost; subsequent Trump-orbit roles); [[Michael Anton]] (Hoover Institution affiliation, first-term NSC, plausibly returning in second term); and a broader bench of Stanford Federalist Society and Hoover-connected figures who staff sub-cabinet positions.

The Thiel-Vance-Palantir spine is operationally significant because it integrates three otherwise separable functions: personnel (Vance as vice president), infrastructure (Palantir's federal data integration footprint), and capital (Founders Fund's continuing investment in the AI-defence-data complex).

## Thiel's intellectual positioning

Thiel's intellectual public-facing positioning ("competition is for losers," monopoly-defence as the right venture-capital posture, openly stated scepticism of democratic accountability for technology development) is documented in his book "Zero to One" (2014, with Blake Masters) and in a longer series of speeches and interviews. The 2016 "What I Believe" address at the Republican National Convention was the first major public alignment with the Trump movement; subsequent appearances and writings have deepened the [[Catholic Integralism]]-adjacent ([[Patrick Deneen]] reading), [[Network States]]-aligned ([[Balaji Srinivasan]] cross-pollination), and [[Effective Accelerationism]]-debating positions that he occupies in the broader intellectual-right landscape.

The Bari Weiss interview and the various Hoover-Institution panel appearances are also useful primary-source material for the contemporaneous Thiel intellectual posture, which the vault tracks as a separate thread from his operational moves.
