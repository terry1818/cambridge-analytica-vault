...
- **Some reporting / Cadwalladr:** Russian-aligned actors influenced Brexit
- **ICO (Denham, 2020):** No evidence of Russian involvement in referendum
- **Status:** `#claim/disputed`

## CA's role in Trump's electoral college win
...
- **Confirmed:** Trump campaign polling data passed via Manafort to Kilimnik
- **Confirmed:** Kogan-Russian-IP infrastructure overlap
- **Confirmed:** Lukoil interest in CA targeting data
- **Not confirmed:** That the specific 87M-profile CA dataset reached Russia (vs. campaign-derived data of which CA was one supplier)
- **Status:** `#claim/disputed` (the strong version); `#claim/verified` (the weak version)

## How the deletion certifications were violated
...
- **Claim (Times, March 2018):** FCO sought CA advice; Boris Johnson met Alexander Nix in 2016
- **No public denial**
