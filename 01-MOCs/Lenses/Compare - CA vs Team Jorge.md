...
# Compare: Cambridge Analytica vs. Team Jorge

**Direct lineage:** [[Tal Hanan]]'s pseudonym **"Jorge" appeared in leaked Cambridge Analytica emails** (per the joint investigation by TheMarker, Radio France, and Haaretz). This is the closest documented organizational continuity between the CA-era and the modern era.

## What ties them

- Tal Hanan / "Jorge" was operationally adjacent to CA in or before 2018
- Both firms sold elections-as-a-service to paying clients globally
- Both used psychological-targeting frameworks
- Both relied on plausible deniability structures (private firms, foreign jurisdictions)
- Both worked across continents
...
Per [[Source Forbidden Stories 2023 Team Jorge]] reporting, multiple ex-Israeli-intelligence operators in the Team Jorge orbit had prior connections to firms in the CA ecosystem ([[Psy-Group]] in particular). The Tal Hanan / "Jorge" pseudonym in CA emails is the **explicit documented bridge**.
