...
| Line item | Amount |
|---|---|
| Coalition with Iowa Farmers Union | $300K |
| Paid ads (rural counties) | $600K |
| Direct mail | $250K |
| Polling | $75K |
| Coordination + comms | $200K |
| **TOTAL 2026** | **$1.425M** |

## Success criteria

- No COS resolution reaches floor vote in either Iowa chamber
- 3+ rural Iowa Republican legislators publicly express concern
- Iowa Farmers Union public opposition
...
The Iowa defensive playbook intersects the broader vault via Iowa's role as an early presidential primary state, the state's [[Article V Convention]] application status, and the [[Citizens for Self-Governance]] state-organising footprint.
