---
date: 2026-05-16
description: Operational playbook for blocking COS HJR 2 / SJR 2 / SB 112 in Ohio 2026; bills already filed with named sponsors
tags: [thread, strategy, state-playbook, state/oh, era/2024-2026]
type: thread
status: active
---
...
| Bill | Chamber | Primary Sponsor(s) | Status | Notes |
|---|---|---|---|---|
| HJR 2 | House | Riordan T. McClain (R-87), Bernard "Bernie" Willis (R-74) | Hearings held | 21 co-sponsors |
| SJR 2 | Senate | Michael Rulli (R-33), Rob McColley (R-1) | Hearings held | |
...
Generate via the app's Counter-Narrative tab:
- **TikTok/IG:** target rural voters in McClain/Willis districts with anti-runaway frame
- **Op-ed pitch:** Ohio Capital Journal already running coverage; pitch follow-on op-ed by Ohio law professor
- **Postcards:** 50K voters per district in HJR 2 priority co-sponsor districts

## Funding ask

| Line item | Amount |
|---|---|
| Coalition coordination + comms | $800K |
| Paid ads (5 priority districts) | $1.2M |
| Direct mail | $375K |
| Polling | $100K |
| Litigation pre-staging | $200K |
| **TOTAL 2026** | **$2.675M** |

## Success criteria

- HJR 2 + SJR 2 + SB 112 do not pass full chambers in 2026
- At least 3 named co-sponsors publicly withdraw
- Litigation pre-staged for the moment any chamber moves to floor vote
- Counter-narrative content reaches 250K+ Ohioans in the priority districts
...
The Ohio defensive playbook intersects the broader vault via Ohio's role in the [[2016 US Presidential Election]] and [[2024 US Presidential Election]], [[JD Vance]]'s home-state political base, [[Vivek Ramaswamy]]'s gubernatorial run, the state's [[Article V Convention]] application status, and the [[Citizens for Self-Governance]] state-organising footprint.

Ohio is operationally distinctive in the vault because of the concentration of Thiel-Vance-Vance-network political infrastructure in the state and the resulting state-level test of the broader [[Tech Right]] political programme.
