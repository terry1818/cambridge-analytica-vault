...
type: organization
legal_name: DeVos family / Dick and Betsy DeVos Family Foundation and adjacent entities
founded: ~1980s (organized political giving)
jurisdiction: US
key_people: [Betsy DeVos, Dick DeVos, Richard DeVos (deceased), Erik Prince]
status: active
---
...
- Confirmed by tiebreaker vote of VP Pence (only Cabinet position requiring tiebreaker in US history at time)
- Pushed school choice and voucher programs
- Reduced enforcement of civil rights protections in education
- Resigned January 7, 2021 (day after January 6 Capitol attack) in formal protest

## Political donations

The DeVos family has been one of the **largest right-wing donor networks** for decades:

- Republican Party donations at federal and state levels
- Multiple right-wing think tanks
- School choice advocacy
- **Substantial donations to [[Leonard Leo]]'s network** including the Federalist Society and adjacent entities
...
- The Trump-administration governance layer
- The Leonard Leo legal-architecture network
- The traditional Christian conservative donor network

## Donations to Leonard Leo network

Per multiple investigative journalism reports, the DeVos family has been **among the largest single donors to Leonard Leo's network** over decades, including:
- Federalist Society direct contributions
- Judicial Crisis Network funding
- Multiple Leo-affiliated 501(c)(4) entities

## Connections

- **Family members:** Betsy DeVos, Dick DeVos, [[Erik Prince]]
- **Wealth source:** Amway
- **Trump first term:** Betsy DeVos Education Secretary
- **CA-successor connection:** [[Erik Prince]] / [[Frontier Services Group]] / [[Emerdata Limited]]
- **Leonard Leo network:** major donor
- **Christian right:** long-time donor network

## Sources

- Multiple investigative journalism on DeVos political giving (NYT, ProPublica, WaPo)
- Mueller Report (Erik Prince Seychelles meeting context)
- Trump first-term Cabinet records
