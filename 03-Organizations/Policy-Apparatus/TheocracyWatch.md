...
type: organization
legal_name: TheocracyWatch (project of CRESP)
aliases: [Theocracy Watch]
founded: 2000
headquarters: Cornell University (CRESP)
jurisdiction: US
parent_org: Center for Religion, Ethics and Social Policy (CRESP), Cornell University
key_people: [Joan Bokaer]
status: active (site may be partially offline as of 2025)
wikipedia_url: https://en.wikipedia.org/wiki/TheocracyWatch
---
...
Nonprofit research project founded in **2000 by Joan Bokaer** following the contested Bush-Gore election. Hosted by Cornell University's **Center for Religion, Ethics and Social Policy (CRESP)**. The project's central thesis: **the religious right has taken substantial working control of the Republican Party**, and its working through Republican-Party institutional infrastructure rather than as a discrete external actor. Bokaer's primary methodology was **studying congressional voting patterns** to gauge dominionist influence over time. The project published a comprehensive web-archive resource called **"Rise of the Religious Right in the Republican Party"** (theocracywatch.org) plus a YouTube playlist of educational videos on dominionism and theocratic ambitions.

**As of September 2025, the original TheocracyWatch.org website was reportedly removed/offline** (per Democracy High reporting). The YouTube playlist remains active. The archive itself is one of the most foundational citizen-research resources documenting the dominionist movement.

## Identity

- **Founded:** 2000
- **Founder:** [[Joan Bokaer]]
- **Parent:** CRESP (Center for Religion, Ethics and Social Policy), Cornell University
- **Website:** theocracywatch.org (partially offline as of 2025)
- **YouTube playlist:** PLX0lPASW58Y6fU03tuTqLBq0hf3qzCjNi

## Key documented findings

- **Dominionism is the theory** that Genesis's "dominion" mandate has become a political teaching that Christians must gain and hold power over secular institutions
- The modern dominionist movement started **1973 with R.J. Rushdoony**, Christian Reconstructionist theologian
- **Moral Majority** (1979-1989) launched the political phase
- **Christian Coalition** (1989-) replaced Moral Majority with more sophisticated grassroots organizing under Ralph Reed
- **Council for National Policy** (1981-) became the coordinating institution
- **Seven Mountains Mandate** (early 2010s) is the current charismatic-evangelical version
- Republican Party voting patterns increasingly align with dominionist priorities since 1980

## YouTube playlist - "Theocracy Watch" series

5+ educational videos covering:

- Part 1-5: "Theocracy Watch: Dominion Theology" series
- Historical lineage from Rushdoony to current
- CNP structure and influence
- Voting-pattern analysis methodology
- Specific case studies of dominionist legislation

YouTube playlist URL: https://www.youtube.com/playlist?list=PLX0lPASW58Y6fU03tuTqLBq0hf3qzCjNi

## How it fits the vault

TheocracyWatch is the **citizen-research / journalism counterpart** to the academic dominionism literature. It documented the theocratic-wing infrastructure 20+ years before that wing became as visible as it is in the Trump 2.0 era. **Bokaer's voting-pattern methodology pre-dates and partially anticipates the personnel-tracking approach this vault uses for Project 2025 contributors.**

The original site being potentially offline matters: **this is research at risk of being lost**. Mirror / archive priority.
...
- [ ] Confirm current online status of theocracywatch.org
- [ ] Mirror the site contents before they're lost
- [ ] Reach out to Joan Bokaer / CRESP about archival
- [ ] Whether the project still updates voting-pattern analysis

## Sources

- [[Source TheocracyWatch.org Rise of Religious Right]]
- [[Source TheocracyWatch YouTube Playlist]]
- [[Source Wikipedia - TheocracyWatch]]
- [[Source Tioga Publishing Bokaer Dangers of Theocracy]]
- [[Source Democracy High 2025 TheocracyWatch Removed]]
