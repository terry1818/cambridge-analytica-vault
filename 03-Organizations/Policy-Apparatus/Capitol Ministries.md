...
type: organization
legal_name: Capitol Ministries
aliases: []
founded: 1996
headquarters: California
jurisdiction: US (501(c)(3))
parent_org: ""
key_people: [Ralph Drollinger]
status: active
---
...
- **Founded:** 1996
- **Founders:** Ralph Drollinger + Danielle Drollinger
- **Type:** 501(c)(3)
- **Footprint:** 43 US state capitols + 20+ international + the White House

## Drollinger's ideological positions (per his own published materials)

- "Institutional" separation of church and state, but the Church should "influence" the State
- Anti-LGBTQ+ (explicitly)
- Anti-women's rights (against women in government leadership)
- Anti-Catholicism (calls Catholicism "one of the primary false religions of the world")
- Anti-Islam (similar framing)
- Pro-undocumented-immigrant child separation (provided theological justification 2018)
- Pro-lower-taxes-on-wealthy (theological framing)
- COVID-era statements blaming China and gay people for the pandemic (March 2020)

## Trump cabinet Bible study (2017-present)

**Weekly Wednesday morning** sessions. Attendees over multiple Trump terms have included:

- Mike Pompeo (State; CIA Director)
- Ben Carson (HUD Secretary)
- Betsy DeVos (Education Secretary)
- Alex Azar (HHS Secretary)
- Jeff Sessions (Attorney General; early)
- Mike Pence (VP, regular attendee)
...
- Largely opaque (501(c)(3) but disclosure-thin)
- Conservative individual donors
- Aligned with broader Christian-right funding networks
- Reported support from major evangelical donors
...
- [ ] Specific Trump 2.0 cabinet attendance list
- [ ] Donor list (largely opaque)
- [ ] Coordination with Project 2025 personnel placement (Vought, Miller, others)
- [ ] State-capitol attendee overlap with ALEC member-legislators
