...
Cambridge Analytica was not an anomaly. It was one visible node in a much older system: a fusion of intelligence, organized crime, blackmail networks, dark money, theocratic-right political infrastructure, and tech-surveillance capital that has been building for nearly a century. This vault traces the people, organizations, money flows, and events across that arc â€” from the post-WWII Mob-FBI compromise through the Mercer/SCL/CA era, into the modern Heritage/Project 2025/Palantir/Convention-of-States power map.

**Three load-bearing hypotheses:**

- [[Federal database supersedes CA model]] â€” Palantir + the March 2025 Trump EO replace CA's third-party data brokerage with direct federal access
- [[Hypothesis - COS is the permanent capture arm of Project 2025]] â€” Convention of States as the constitutional vector locking in Project 2025 beyond electoral cycles
- [[Hypothesis - Three-wing coalition]] â€” patron capital + theocratic infrastructure + tech-surveillance form one operational coalition, not three separate movements

## Start here â€” pick your time budget
...
**Synthesis:**
- [[Lens - 2024-2026 Power Map]] â€” current architecture of the right at a glance
- [[Lens - COS as Constitutional Capture Vector]] â€” the Article-V mechanism explained
- [[Deep Dive - Three Wing Coalition Anatomy]] â€” master synthesis
- [[Epstein Network MOC]] â€” capstone case study tying the blackmail architecture to the present

**Actionable output:**
- [[Counter-COS Strategy for the Left]] â€” what to actually do about it
- State playbooks for OH, PA, IA, WY, VA (see `09-Threads/State-Playbooks/`)

**Methodology:**
- [[How to Use the Vault]]
- [[Evidence Tiers]] â€” the Tier 1 / Tier 2 / Tier 3 framework
- [[Methodology - Verifying a CA claim]]
- [[Conventions]] â€” naming, linking, citation rules

## Navigating this site

- **Graph view** (right sidebar) â€” every wikilink connection across 2,000+ notes
- **Full-text search** (top toolbar) â€” instant search
- **Explorer** (left sidebar) â€” folder tree of the whole vault
- **Backlinks** (right sidebar, per note) â€” what links into each note
...
02-People/            Individuals â€” operators, funders, theorists, victims
...
07-Connections/       Relationship notes â€” money flows, personnel, data flows
...
## Evidence tiers â€” read this before quoting anything

Every claim is labeled by evidence strength. **The tier is the disclaimer.**

- **Tier 1 â€” Documented.** Court filings, FBI files, FEC records, leaked corporate documents, sworn testimony with corroboration, peer-reviewed research. Citable directly.
- **Tier 2 â€” Inferred from solid evidence.** Reasonable inferences from Tier-1 facts, mainstream investigative journalism with named sources, multiple independent reportings. Cite with attribution.
- **Tier 3 â€” Contested / single-source / under-evidenced.** Single-witness claims, allegations without corroboration, plausible patterns without smoking guns. **Cite as allegation, not fact.**
...
- PRs welcome â€” sourced additions only. Speculation without sources gets closed.
