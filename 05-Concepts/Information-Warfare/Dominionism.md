...
type: concept
domain: theological
first-documented: 1973 (Rushdoony's Institutes of Biblical Law)
aliases: ["Dominion Theology"]
---
...
- [[Russ Vought]]'s Christian-nationalist self-identification and Schedule F program
- The [[Seven Mountains Mandate]] strategy
- [[Project 2025]]'s policy frame
- [[Convention of States Action]]'s constitutional capture goals
- [[Alliance Defending Freedom]]'s litigation strategy (e.g. Dobbs)
- The federal-lands-transfer agenda (matches "have dominion over the earth")

## Origin

The contemporary movement traces to **[[R.J. Rushdoony]]'s 1973 *Institutes of Biblical Law*** and the broader [[Christian Reconstructionism]] he developed at [[Chalcedon Foundation]] (founded 1965).

**Note on terminology:** "Dominion theology" and "dominionism" are sometimes used interchangeably; sometimes "Dominion Theology" refers specifically to [[Christian Reconstructionism]] while "dominionism" is the broader political application. [[TheocracyWatch]] uses "dominionism" as the umbrella term.

## Variants

### Christian Reconstructionism (Rushdoony tradition)
- Postmillennial: Christ returns AFTER Christians gradually establish dominion
- Theonomic: Old Testament biblical law as governing template
- Slow-and-steady infiltration strategy

### Seven Mountains Mandate (1975 Bright/Cunningham; 2000s charismatic)
- Identifies 7 cultural "mountains" Christians must control: government, education, media, arts/entertainment, religion, family, business
- Charismatic-evangelical orientation
- More immediate-action strategy
- See [[Seven Mountains Mandate]]

### Christian Nationalism (current popular term)
- Less theological specificity than Reconstructionism
- More broad-base political mobilization
- Self-identified by [[Russ Vought]] and others
- Often combined with white-nationalist or ethno-nationalist content

## Application in this domain

- Theological grammar of [[The Fellowship]] (operationalizes via personal-relationship strategy)
- Theological grammar of [[Capitol Ministries]] (operationalizes via cabinet Bible study)
- Theological grammar of [[Alliance Defending Freedom]] (operationalizes via litigation)
- Theological grammar of [[Project 2025]] (operationalizes via executive-branch capture)
- Theological grammar of [[Convention of States Action]] (operationalizes via constitutional amendment)
- Theological grammar of [[United in Purpose]] / [[Gloo]] / [[COFI]] (operationalizes via psychographic-targeting + church recruitment)

## How dominionists describe their goals vs. how critics describe them

| Dominionist framing | Critical framing |
|---|---|
| "Christians influencing culture" | Theocratic takeover |
| "Reclaiming the founding" | Imposing theological rule |
| "Religious liberty" | Establishment of state religion |
| "Parental rights in education" | Christian-curriculum imposition |
| "Pro-family values" | Anti-LGBTQ, anti-women's-rights program |
| "Limited government" | Dismantling secular-democratic state |

## Effectiveness / critique

- Substantial documented success in capturing GOP institutional power
- [[TheocracyWatch]] documented increasing dominionist voting alignment in Congress over 20 years
- Dobbs (2022) widely viewed as dominionist legal milestone
- Project 2025 implementation is operational dominionism

Academic critique:

- Most evangelicals do not self-identify as dominionists
- The label can be over-applied
- But the political-program effects are well-documented regardless of self-identification
...
- [[Source Religion Unplugged Biblical Law]]
